...
/**
 * 微信服务对接，对接地址：<a href="http://callback.example.com/api/v1/weixin/portal/receive">/api/v1/weixin/portal/receive</a>
 * <p>
 * http://callback.example.com/api/v1/weixin/portal/receive/
 */
@Slf4j
@RestController()
@CrossOrigin("*")
